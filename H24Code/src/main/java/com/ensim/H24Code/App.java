...
public class App 
{
    public static void main( String[] args )
    {
		...
		com.createTrack("Track fourmi 3 Aller fourmi supersonic qui roule a 325km/h on peut pas la rattraper elle va vraiment super vite franchement j'attends les cigales",token3, seedIdDepart, seedId3);
		try {
			idTrack3Aller=com.createTrack("Track fourmi 3 Aller fourmi supersonic qui roule a 325km/h on peut pas la rattraper elle va vraiment super vite franchement j'attends les cigales", token3, seedIdDepart, seedId3).body().string().split("_id\":\"")[1].split("\",\"")[0];
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		com.endTrack("Track fourmi 3 Retour","balade posey", idTrack3Retour, token3);
		System.out.println("test end track3 retour: "+com.endTrack("Track fourmi 3 Retour","balade posey",idTrack3Retour, token3).isSuccessful());
